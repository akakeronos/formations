# Plan de formation pour le 6 décembre 2017
## slide 1 Corpus théorique
**Définitions**

> Record management : organisation des opérations permettant de contrôler les processus de production documentaire

> L’archivage numérique pérenne des documents électroniques : conserveration des documents et données et des informations qu’ils contiennent :
...
## slide 2 **norme de gestion des activités documentaires**
...
## slide 3 **Un petit détour par la vision processus**
...
##slide 4 Les activités sur les données
![Diversité des activités](/pin/media/rosaceActivites.png)
...
## slide 6 : collectivisation de la production
...
## slide 7 Cycle de vie des documents engageants (records)
...
## slide 8  continuum information

![schéma d'illustration du continuum du cycle de vie](/pin/media/continuiteInformation.png)

## slide 9 La gestion de l'archivage au sens du records management : 2 cycles de besoins parallèles :
* ceux de la production/utilisation
* ceux des outils de conservation/logistique

## slide 10  parallelisme des âges

![schéma d'illustration du parallélisme des besoins de gestion](/pin/media/paralleleActivite.png)


## slide 11 Qualifier et classer l'information numérique : caractéristiques internes et externe ;
### slide 12 caractéristiques internes
* nom (identifiant)
* titre
* description
* date de création
...
### slide 12 caractéristiques externes
* version
...
## slide 13 Contraintes réglementaires et risques : archiver pour prouver et pour tracer ;
...
## slide 14 Gestion de la qualité
...
## slide 15 Enjeux pour l'organisation
...
## slide 16 Evaluation de la production
...
## slide 17 certification de la production
...
## slide 19 Gouvernance documentaire
...
-> une analyse des **processus** de travail  + **règlementation** + **besoins** de gestion
