...
Mettre en production un SAE au Département de la Seine-et-Marne
---
## Règles du jeu
...
name: 1.1
# internalisation :
* aller à la page [sc-interne](slideshow.html#sc-interne)
* aller à la page [sc-interne](#sc-interne)
---
name: 1.1.1
# j'ai déjà un SAE :
    [se poser les 9 question](#mvp-qquestion)
---
name:   1.1.1.1
# écrire le profil
...
---
name: 1.1.1.5
# procéder au versement d'un marché : https://github.com/akakeronos/formations/raw/master/ad77/exemples/exempleMarche.zip.zip
---
name: 1.1.1.5.1
...
---
name 1.3
# externalisation AI et AD : aller à la page [sc-depot-EPCI](#sc-depot-EPCI)
---
2. Je suis une EPCI à fiscalité propre et je veux archiver électroniquement mes flux comptables
---
3. Je suis le Département de la Seine-et-Marne et je veux archiver les séances des délibérations et les vidéos de l'assemblée
---
...
## **Scénario 2 : dépôt au sein d'un EPCI** : La collectivité externalise son archivage
